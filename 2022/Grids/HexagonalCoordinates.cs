...
public static class HexagonalCoordinates
{
    ...
    public static Dictionary<Vector2, Vector2[]> GenerateHexagonalCoordinates(int sizeX, int sizeY, GameObject hexagonPrefab, float hexagonSizeX, float hexagonSizeY)
    {
